...
const UpdateCompetition = ({
  ...
  const totalPointsDfault =
    100 +
    10 *
    (positivePoint.point_1.time +
      positivePoint.point_2.time +
      positivePoint.point_3.time +
      positivePoint.point_4.time +
      positivePoint.point_5.time -
      negativePoint.point_1.time -
      negativePoint.point_2.time -
      negativePoint.point_3.time -
      negativePoint.point_4.time -
      negativePoint.point_5.time -
      negativePoint.point_6.time)
    ...
    <div className={s.root}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className={s.overview}>
          ...
          <div>Xếp loại: {classificationFunc(+totalPoints !== 100 ? +totalPointsDfault : totalPoints)}</div>
        </div>
